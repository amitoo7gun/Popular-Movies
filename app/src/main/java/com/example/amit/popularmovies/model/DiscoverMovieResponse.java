...
public class DiscoverMovieResponse implements Parcelable {
    ...
    @Expose
    private List<MovieDiscoverResult> results = null;
    ...
    protected DiscoverMovieResponse(Parcel in) {
        ...
        results = in.createTypedArrayList(MovieDiscoverResult.CREATOR);
    }
    ...
    public List<MovieDiscoverResult> getResults() {
        return results;
    }

    public void setResults(List<MovieDiscoverResult> results) {
